      ...
      <div className="bg-surface">
        <div className="flex flex-col lg:flex-row max-h-screen">
          ...
          <div className="w-full lg:w-7/12">
            <AuthScreenSection
              title="Built for Artists Who Own the Stage"
              description="Join Hoizr to showcase your talent, connect with agencies and event hosts, and manage your bookings — all from one powerful platform designed for performers like you."
